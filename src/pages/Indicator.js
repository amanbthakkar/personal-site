        ...
        <div className='bg-success text-white p-1'>
          ...
          {showInfo && (
            <div className='info-bar text-center'>
              ...
              <br />
              Visit counts are maintained using Redis as cache and database on
              an Amazon EC2 host.
            </div>
          )}
        </div>
          ...
          <Container>
            ...
            <Container>
              <p>
                ...
                The oscillator (a value that lies between -1 and 1) can be used
                as a tool that helps us understand if Bitcoin's price is too
                high or too low compared to its historical patterns. Think of it
                like a gauge. It looks at Bitcoin's current price and compares
                it to where it's expected to be "on average" based on past data.
                When the gauge is in the red zone, it might mean Bitcoin is
                getting overvalued, and selling could be a good idea. But when
                it's in the blue zone, it might be a good time to buy because
                Bitcoin could be undervalued.{' '}
              </p>
              <p>
                The plot above is a scatterplot of Bitcoin's price color-coded
                on which percentile the oscillator value belongs to at any given
                point in time (you may want to read the article linked above).
                Blue regions are closer to the 10th percentile, while red
                regions are closer to the 90th percentile.
              </p>
              <p>
