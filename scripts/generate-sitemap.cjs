...
const routes = [
  ...
  { path: '/power-law-oscillator-indicator', priority: '0.8', changefreq: 'daily' },
  { path: '/url-shortener', priority: '0.7', changefreq: 'monthly' },
  { path: '/contact', priority: '0.7', changefreq: 'yearly' },
];

const baseUrl = 'https://amanthakkar.com';
